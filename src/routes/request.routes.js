...
router.get(
  "/craftsman",
  requestController.getCraftsmanRequests
);
...
router.put(
  "/:id",
  [
    check("service", "وصف الخدمة مطلوب")
      .optional()
      .notEmpty(),
    check("description", "وصف المشكلة مطلوب")
      .optional()
      .notEmpty(),
    check("location", "الموقع مطلوب")
      .optional()
      .notEmpty(),
    check("location.address", "العنوان مطلوب")
      .optional()
      .notEmpty(),
    check("location.lat", "خط العرض مطلوب")
      .optional()
      .isNumeric(),
    check("location.lng", "خط الطول مطلوب")
      .optional()
      .isNumeric(),
    check("preferredDates", "التواريخ المفضلة مطلوبة")
      .optional()
      .isArray({ min: 1 }),
  ],
