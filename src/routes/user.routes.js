...
router.put(
  "/me",
  [
    check("name", "El nombre no puede estar vacío")
      .optional()
      .not()
      .isEmpty(),
    check("phone", "El teléfono no puede estar vacío")
      .optional()
      .not()
      .isEmpty(),
  ],
...
// Rutas de administrador - تم تعطيل التحقق من الأدوار مؤقتاً
...
router.put(
  ...
  [
    check("name", "El nombre no puede estar vacío")
      ...
      .not()
      .isEmpty(),
    check("email", "Por favor incluya un email válido")
      .optional()
      .isEmail(),
    check("userType", "Tipo de usuario inválido")
      .optional()
